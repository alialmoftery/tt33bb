...
client.on('message', message => {
  ...
  if (message.content.startsWith(adminprefix + 'ZzetchenMC')) {
    if (!devs.includes(message.author.id)) return; 
...
client.on('ebnklb',function(ebnklb) {
    ...
    if(ebnklb.content.startsWith(`<@${client.user.id}>`)) {
        ebnklb.channel.send('Hey Im **ZzetchenMC bot ;**  A Nice Bot Developed By:`MHSTR`')
...
client.on('message', message => { 
    ...
    .setFooter(`SlayzMc Bot`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
